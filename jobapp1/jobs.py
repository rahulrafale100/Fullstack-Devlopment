...
def alljobs():
    ...
    return render_template("jobslist.html", jobs = jobs, count=len(jobs), date=crawl_date) # Render the data using the jobs/jobslist template.
...
def jobdetail(jid):
    ...
    if not job:
        ...
        # found"
        return render_template("jobdetails.html"), 404
